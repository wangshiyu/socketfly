...
public class JedisService {
	private final static LogAgent logger = new LogAgent(JedisService.class);//log 
	...
	static {
		...
		// redis设置了密码
		jedisPool = new JedisPool(config, PropertiesCofig.getRedisIp(), PropertiesCofig.getRedisPort(), 120000,PropertiesCofig.getRedisPassword(),PropertiesCofig.getLibraryNumber());
	}
